    ...
    <Card className="hover:shadow-xl transition-all duration-300 border-blue-200 dark:border-blue-900 bg-gradient-to-br from-blue-50 to-white dark:from-gray-800 dark:to-gray-900">
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          ...
          <span className="text-sm font-normal text-gray-500 dark:text-gray-400">Overview</span>
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="space-y-3">
          <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Status Breakdown</h4>
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
          <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Active by Priority</h4>
          <div className="flex justify-between items-center">
