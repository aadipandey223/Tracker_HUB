  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "text-gray-500 rounded-md w-9 flex-1 font-normal text-[0.8rem] dark:text-gray-400 text-center",
        ...
        day_selected:
          "bg-orange-600 text-white hover:bg-orange-600 hover:text-white focus:bg-orange-600 focus:text-white dark:bg-orange-500 dark:hover:bg-orange-500 dark:focus:bg-orange-500",
